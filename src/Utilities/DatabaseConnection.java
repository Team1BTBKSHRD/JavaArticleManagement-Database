...
public class DatabaseConnection {
	...
	public static Connection getConnection() throws SQLException,
		...
		Connection conn = DriverManager
				.getConnection("jdbc:postgresql://localhost:5432/dbarticle",
						"postgres", "123");
		return conn;
	...
	/*
	 * Auto Creating Database --return string
	 */
	public static String createDatabase() throws ClassNotFoundException,
			SQLException {
		Class.forName("org.postgresql.Driver");
		Connection con = DriverManager.getConnection(
				"jdbc:postgresql://localhost:5432/", "postgres", "123");
		PreparedStatement stm = con
				.prepareStatement("SELECT datname FROM pg_database WHERE datname='dbarticle';");
	 ...
	 */
	public static String createDatabaseDefinition()
